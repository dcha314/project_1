...
def user_wt_returns(applicant_info):
    ...
    user_returns_event_2001 = cumulative_returns_event_2001.mul(applicant_info).sum(axis=1)
    user_returns_event_2001.plot(figsize=(20, 10), title="User Portfolio Returns - Event 2001")
    plt.savefig("User Portfolio Returns - Event 2001")
    print(f"your return during 911 is {user_returns_event_2001[-1]:.2%}")

    #calcuate portfolio return on user allocation
    user_returns_event_2003 = cumulative_returns_event_2003.mul(applicant_info).sum(axis=1)
    user_returns_event_2003.plot(figsize=(20, 10), title="User Portfolio Returns - Event 2003")
    plt.savefig("User Portfolio Returns - Event 2003")
    print(f"your return during War is {user_returns_event_2003[-1]:.2%}")
    #calcuate portfolio return on user allocation
    user_returns_event_2008 = cumulative_returns_event_2008.mul(applicant_info).sum(axis=1)
    user_returns_event_2008.plot(figsize=(20, 10), title="User Portfolio Returns - Event 2008")
    plt.savefig("User Portfolio Returns - Event 2008")
    print(f"your return during housing bubble is {user_returns_event_2008[-1]:.2%}")
    #calcuate portfolio return on user allocation
    user_returns_event_2020 = cumulative_returns_event_2020.mul(applicant_info).sum(axis=1)
    user_returns_event_2020.plot(figsize=(20, 10), title="User Portfolio Returns - Event 2020")
    plt.savefig("User Portfolio Returns - Event 2020")
    print(f"your return during Covid is {user_returns_event_2020[-1]:.2%}")
    #calcuate portfolio return on user allocation
    user_returns_event_2022 = cumulative_returns_event_2022.mul(applicant_info).sum(axis=1)
    user_returns_event_2022.plot(figsize=(20, 10), title="User Portfolio Returns - Event 2022")
    plt.savefig("User Portfolio Returns - Event 2022")
    print(f"your return during Invasion is {user_returns_event_2022[-1]:.2%}")

    return user_returns_event_2001,user_returns_event_2003,user_returns_event_2008,user_returns_event_2020,user_returns_event_2022
